...
inline void
fillFieldsForPointcloud(std::vector<sensor_msgs::msg::PointField>& fields)
{
...
boost::optional<sensor_msgs::msg::PointCloud2>
readLidarFile(const fs::path& filePath)
{

  sensor_msgs::msg::PointCloud2 cloud;
  cloud.header.frame_id = std::string("lidar_top"); // lidar -> lidar_top
  ...
  return boost::optional<sensor_msgs::msg::PointCloud2>(cloud);
}
